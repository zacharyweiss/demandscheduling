"""
This code is a snippet from the "urbs" model by the Chair of Renewable and Sustainable Energy Systems at the Technical
University of Munich, and it is used here under its GNU General Public License. All credit to the authors.
More information can be found at: https://github.com/tum-ens/urbs

This provides an easy I/O for pyomo, retrieving variables from the solved model back into pandas dataframes.
"""
